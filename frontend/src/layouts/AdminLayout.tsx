...
const navItems = [
  ...
  { to: "/admin/backup-restore", label: "Data", icon: Database },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 flex">
      ...
      <aside
        ...
        } transition-all duration-500 bg-white/80 backdrop-blur-2xl shadow-2xl border-r border-white/20 flex flex-col relative z-50`}
      >
        ...
        <div className="p-4 border-t border-gray-200/50">
          <div
            className={`flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 ${
